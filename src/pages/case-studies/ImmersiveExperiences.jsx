...
const INSIGHTS = [
  ...
  },
  {
    ...
    detail: "The DM led with value and removed all friction immediately. No lengthy pitch, no contract requirements, no posting obligations. Just: 'We love your content and think you'd love this experience — here are two free tickets, keep creating great stuff.' The 73% acceptance rate validates the approach. When you lead with genuine value and ask for nothing in return, the response rate speaks for itself.",
  ...
  },
  {
    ...
    headline: "The experience did the creative work.",
    detail: "The core strategic insight: the product is inherently photogenic. The immersive, interactive exhibits are designed to be experienced and shared. Rather than briefing influencers on what to post or how to frame the brand, we trusted the product. People who love creating content walked into a space optimized for content creation. The result was authentic, diverse, high-quality posts that no paid campaign brief could have produced.",
...
export default function CaseStudyImmersiveExperiences() {
      ...
      <div style={{ background: "#0C0C0C", borderTop: "1px solid #151515", borderBottom: "1px solid #151515", padding: "64px 40px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 13, color: "#555", lineHeight: 1.8 }}>
            The brand's immersive exhibits are inherently photogenic. People who love creating content walk into a space optimized for content creation. The insight wasn't about influencer marketing tactics — it was about recognizing what the product already was, and removing every obstacle between that product and the people most likely to share it.
          </p>
        </div>
      </div>
