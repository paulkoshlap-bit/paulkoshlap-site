...
const cpaCompare = [
  { name: 'Platform\nReported', value: 100, fill: '#B44444' },
  { name: 'Incremental\nReality', value: 16, fill: '#C8A96E' },
]
...
const PHASES = [
  {
    ...
    desc: 'The client\'s internal data science team surfaced an early incremental-lift signal in high-propensity zip codes. I translated that finding into the basis for a larger, more rigorous test.',
    highlight: false,
  },
  {
    n: '02', title: 'Stakeholder Alignment & Buy-In',
    desc: 'Bridged the client\'s internal data science team and an external advanced analytics team — translating measurement science into business language that earned stakeholder confidence and greenlit a full-scale test.',
    highlight: true,
  },
  {
    n: '03', title: 'Test Design & Build',
    desc: 'Using the client\'s internal data, I made recommendations on what and where to test and how to structure it, designed the test structure with guidance from the advanced analytics team, and built all the campaigns. Synthetic control geo selection, 4-week window.',
    highlight: false,
  },
  {
    n: '04', title: 'Analysis & Projection',
    desc: '13% lift confirmed in targeted geos. Nationalized to project roughly eight figures in incremental revenue at a healthy return on ad spend.',
    highlight: false,
  },
]

export default function CaseStudyIncrementalityHealth() {
    ...
    <div style={{ paddingTop: 60 }}>
      ...
      <div style={{ padding: '80px 40px 60px', maxWidth: 900, margin: '0 auto' }}>
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 24 }}>
          <span className="badge">DTC · Consumer Health &amp; Wellness</span>
        ...
        <p style={{ fontSize: 14, color: '#666', lineHeight: 1.8, maxWidth: 580, marginBottom: 48 }}>
          Touch-based attribution was blind to a DTC health brand's highest-value customers. A synthetic control geo test revealed what the platform couldn't measure — and projected roughly eight figures in incremental revenue at a strong return on ad spend.
        </p>

        {/* Metrics */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 16 }}>
          {[
            { v: '~$50M', l: 'Incremental Revenue (Projected)' },
            { v: 'Strong', l: 'Return on Investment' },
            { v: '13%', l: 'Geo Lift' },
      ...
      <div className="section">
        ...
        <p style={{ fontSize: 12, color: '#555', lineHeight: 1.8, maxWidth: 520, marginBottom: 40 }}>
          Platform-reported acquisition cost overstated the true incremental cost by roughly 6x. The difference wasn't a rounding error — it was the entire strategic narrative for the channel. (Indexed to protect client data; platform-reported = 100.)
        </p>
        ...
        <div style={{
          ...
          Every dollar of this incremental revenue would have been defunded as "unproven" based on platform numbers alone. Without incremental measurement, the entire channel investment would have been cut — eliminating the very spend driving real business outcomes.
        </div>
      </div>
      ...
      <div className="section-alt">
        <div className="section-alt-inner">
          ...
          <p style={{ fontSize: 12, color: '#555', lineHeight: 1.8 }}>
            The incremental revenue didn't exist until someone asked the right question, spearheaded the right test, and convinced the right people to run it. That translation layer — knowing which methodology to use and being able to explain it to a CMO in a way that moves the conversation forward — is as valuable as the measurement itself.
          </p>
        </div>
      </div>
