...
const CASE_STUDIES = [
  {
    ...
    tag: 'DTC · Consumer Health & Wellness',
    metric: '~$50M',
    metricLabel: 'Incremental Revenue',
    desc: 'Synthetic control geo test revealed roughly eight figures in revenue completely invisible to touch-based attribution — and convinced stakeholders to act on the methodology.',
    href: '/work/incrementality-health',
    color: '#C8A96E',
  },
  {
    num: '001',
    title: 'AI-Powered Creative Strategy System',
    tag: 'DTC + B2B · Multi-Vertical',
    metric: '22%',
  ...
  {
    num: '002',
    title: 'Research-Led Creative Wins for a Local Healthcare Brand',
    tag: 'DTC · Local Services (Healthcare) · Meta Ads',
    metric: '17%',
    metricLabel: 'CPA Reduction',
  ...
  },
  {
    ...
    href: '/work/immersive-experiences',
    color: '#7EC8C8',
  },
]
