...
const CASE_STUDIES = [
  {
    ...
    subMetric: 'Strong ROI · 13% geo lift',
    desc: 'Synthetic control geo test revealed roughly eight figures in revenue completely invisible to touch-based attribution — and a stakeholder education effort that changed how the client thinks about measurement.',
  ...
  },
  {
    ...
    tags: ['DTC + B2B · Multi-Vertical', 'Meta Ads', 'AI Workflows'],
    metric: '22%',
